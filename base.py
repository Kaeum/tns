...
#시간
wait.until(ec.element_to_be_clickable((By.XPATH, ('//*[text()[contains(., "%s")]]' % TIME)))).click()
...
#일반결제 클릭
wait.until(ec.element_to_be_clickable((By.XPATH, '//li[contains(@class, "_generalPaymentsTab")]/div/span'))).click()
